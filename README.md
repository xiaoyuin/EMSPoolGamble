...
这是一个功能完整的多人台球计分 Python Flask Web App，支持移动端浏览器访问。经过 v1.6.0 版本升级，实现了完整的特殊胜利高亮系统和计分记录排序优化，提供更佳的用户体验。
...
**🎱 EMSPoolGamble v1.6.0 - 特殊胜利高亮系统与计分优化，专业游戏管理平台升级完成！**
